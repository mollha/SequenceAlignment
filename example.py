...
if __name__ == "__main__":
    ...
    score, out1_indices, out2_indices, out1_chars, out2_chars = heuralign(alphabet, scoring_matrix, sequence1,
                                                                          sequence2)
# TESTS
...
scoring_matrix = [[1, -5, -5, -5, -1], [-5, 1, -5, -5, -1], [-5, -5, 5, -5, -4], [-5, -5, -5, 6, -4],
                  [-1, -1, -4, -4, -9]]
alphabet = "ABCD"
string_1, string_2 = "AACCDDDDABABDBABCBBCAAABBAACDDADAACCCADDCCBCBACCBBDCBDBCBCBAADDCBCBDDDCDD", "CADDCCBCBACCBBDCBDBCBCBAADDCBCBDDDCDDCADDCCBCBACCBBDCBDBCBCBAADDCBCBDDDCDD"
print(len(string_1))
print(len(string_2))
